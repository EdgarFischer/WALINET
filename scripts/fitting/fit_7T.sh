...
# Example: WALINET + classical forD fitting for 7T Vol1_Brisbane.
...
SUBJECT_DIR="$WALINET_ROOT/data/7T/B0corrected_wo_LipidMask/MS_180"
...
FORD_CONFIG="$WORKSPACE_ROOT/forD/runs/classical_fitting_config_Hauke_7T.json"
LOG_DIR="$WALINET_ROOT/logs/logs_fitting"
TIMESTAMP="$(date +'%Y%m%d_%H%M%S')"
LOG_FILE="$LOG_DIR/fit_7T_${TIMESTAMP}.log"
MODEL_FOLDER_NAME="7T_Final"
