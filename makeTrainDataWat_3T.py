...
N= 288 # This is FID length. Vienna: 7T: 840, 3T: 288
NMRFreq= 123231706.0 # (Lamor frequeny) Vienna : 7T: 297222931, 3T: 123231706
...
for sub in subjects:
    ...
    list_file = glob.glob('MetabModes/3T_TE0/*Exact_Modes.txt')
    NbM = len(list_file)
