...
# Water Removal
b_RemWat = True
WatSuppComp = 16 # Number of component for the HSVD water removal (advised: 16 at 3T and 32 at 7T)
minFreq = -74 # -150Hz(7T); should be 64 at 3T (Haukes kommentar) # +-0.5ppm 
maxFreq = 74 # 150
parallel_jobs = 20

bandwidth = 939.85 # Vienna: 2778 at 7Tm 939.85 at 3T
...
for sub in subjects:
    ...
    if b_RemWat:
        ...
        np.save(p_save + f'IsolatedWater_{version}.npy', water_rrrt)
        np.save(p_save + f'SupressedWater_{version}.npy',  image_rrrt)
