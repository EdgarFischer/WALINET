...
params["model_name"] =  "Test"#"3T_1.0"#"EXP_1"# "test"# 
params["path_to_model"] = "models/" + params["model_name"] + "/"
params["path_to_data"] = 'data/3T/'

# params["train_subjects"]=['Vol01_WB/Res64x64_Thick', 'Vol01_WB/Res64x64_Thin',
...
params["train_subjects"]=['Vol01_WB/Res64x64_Thick']
